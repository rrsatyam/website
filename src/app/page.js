...
const Home = () => {
  ...
  return (
    <div className="overflow-x-hidden">
          ...
          <div className="bg-[--bg-shadow-color] absolute inset-0 space-y-3 ">
            <div className="absolute bottom-[20%] left-[13%]">
              <Fade
                ...
                damping={1e-1}
              >
                <p className="gradient-text !font-bold text-4xl sm:text-6xl md:text-[82px] m-0">
                  Hello
                  <br />
                  I&apos;m Raju
                </p>
              ...
              >
                <div className="flex flex-col sm:flex-row justify-start items-start sm:items-center mt-10 space-y-3 sm:space-y-0 sm:space-x-7">
                  ...
                  <a
                    className="text-[--white-color] underline hover:text-[--theme-red-color] transition-all ease-in-out duration-500 italic"
                    href="mailto:satyam1105@gmail.com"
                  >
                    satyam1105@gmail.com
                  </a>
                </div>
              </Fade>
            </div>
          ...
          <div className="bg-[--bg-shadow-color] absolute inset-0 space-y-3">
            <div className="mx-auto absolute bottom-[20%] left-[10%]">
              <Fade
                ...
                damping={1e-1}
              >
                <p className="gradient-text font-bold text-4xl sm:text-6xl md:text-[82px] mb-0">
                  Hello <br />
                  I&apos;m Rakesh
                </p>
              </Fade>
      ...
      <button
        className="absolute top-[50%] translate-y-[-50%] cursor-pointer bg-[--slider-button-color] hover:bg-[--theme-red-color] transition-all ease-in-out duration-500 left-2 p-2 md:left-6 lg:left-10 lg:p-4 rounded-[50%] "
        onClick={() => sliderRef.current.slickPrev()}
      >
        <ArrowBackIcon fontSize="large" className="text-[--white-color] z-1" />
      </button>
      <button
        className="absolute top-[50%] translate-y-[-50%] cursor-pointer bg-[--slider-button-color] hover:bg-[--theme-red-color] transition-all ease-in-out duration-500 right-2 p-2 md:right-6 lg:right-10 lg:p-4 rounded-[50%]"
        onClick={() => sliderRef.current.slickNext()}
      >
        <ArrowForwardIcon
          fontSize="large"
          className="text-[--white-color] z-1"
        />
      </button>
      <Category />
    </div>
